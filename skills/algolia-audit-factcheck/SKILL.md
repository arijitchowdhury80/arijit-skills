...
```
AUDIT_DIR  = ~/Library/CloudStorage/GoogleDrive-REDACTED@example.com/My Drive/AI/MarketingProject/Algolia Search Audit
...
`$AUDIT_DIR = ~/Library/CloudStorage/GoogleDrive-REDACTED@example.com/My Drive/AI/MarketingProject/Algolia Search Audit` If none found, ask the user.
