...
`~/Library/CloudStorage/GoogleDrive-REDACTED@example.com/My Drive/AI/MarketingProject/Algolia Search Audit`

### CORRECT
`$ALGOLIA_AUDIT_DIR`

### $ALGOLIA_AUDIT_DIR value
`/Users/arijitchowdhury/Library/CloudStorage/GoogleDrive-REDACTED@example.com/My Drive/AI/MarketingProject/Algolia Search Audit`
